...
- [提示工程](#提示工程)
  - [提示结构](#提示结构)
  - [大语言模型LLM相关设置](#大语言模型LLM相关设置)
- [QA](#QA)
  - [文本大模型与视觉大模型](#文本大模型与视觉大模型)
  - [大模型命名](#大模型命名)
  - [调用模型 API 的角色设定](#调用模型API的角色设定)
  - [模型的参数](#模型的参数)
  - [模型的计费](#模型的计费)
  - [Prompt 基本使用，优化技巧（few-shots）](#Prompt基本使用)
  - [API 高阶使用](#API高阶使用)
  - [RAG(Retrieval-Augmented Generation) 如何使用](#RAG)
- [扣子](#扣子)
...
组合提示(Combining Prompting Techniques) CPT
...
自洽性提示(Self-Consistency Prompting)技术
...
零样本思维链提示(Zero-Shot Chain-of-Thought Prompting，Zero-Shot CoT)
